...
open class MoyaProvider<Target: TargetType> {
    ...
    open func request(_ target: Target, completion: Moya.Completion) -> Cancellable {
    ...
    open func request(_ target: Target, queue: DispatchQueue?, progress: Moya.ProgressBlock? = nil, completion: Moya.Completion) -> Cancellable {

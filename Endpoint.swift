...
public class Endpoint<T> {
    ...
    let sampleResponse: NSData
    let parameters: [String: AnyObject]?
    
    public init(URL: String, method: Moya.Method, parameters: [String: AnyObject], sampleResponse: NSData) {
        self.URL = URL
    ...
    public convenience init(URL: String, parameters: [String: AnyObject], sampleResponse: NSData) {
        self.init(URL: URL, method: Moya.Method.GET, parameters: parameters, sampleResponse: sampleResponse)
    }
    
    public convenience init(URL: String, sampleResponse: NSData) {

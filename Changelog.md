...
- Fixed SPM integration so it no longer fetches testing libraries & doesn't create runtime crashes or Xcode Preview crashes anymore. [#1923](https://github.com/Moya/Moya/pull/1923) by [@sunshinejr](https://github.com/sunshinejr).

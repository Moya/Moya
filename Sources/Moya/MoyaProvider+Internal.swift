...
public extension MoyaProvider {
    ...
    func requestNormal(_ target: Target, callbackQueue: DispatchQueue?, progress: Moya.ProgressBlock?, redirectHandler: RedirectHandler? = nil, cachedResponseHandler: CachedResponseHandler? = nil, completion: @escaping Moya.Completion) -> Cancellable {
        ...
        let performNetworking = { (requestResult: Result<URLRequest, MoyaError>) in
            ...
            cancellableToken.innerCancellable = self.performRequest(target, request: request, callbackQueue: callbackQueue, progress: progress, redirectHandler: redirectHandler, cachedResponseHandler: cachedResponseHandler, completion: networkCompletion, endpoint: endpoint, stubBehavior: stubBehavior)
        }
    ...
    private func performRequest(_ target: Target, request: URLRequest, callbackQueue: DispatchQueue?, progress: Moya.ProgressBlock?, redirectHandler: RedirectHandler? = nil, cachedResponseHandler: CachedResponseHandler? = nil, completion: @escaping Moya.Completion, endpoint: Endpoint, stubBehavior: Moya.StubBehavior) -> Cancellable {
        ...
        let onSendUploadMultipart: (MultipartFormData) -> Cancellable = { multipartFormData in
            ...
            return self.sendUploadMultipart(target, request: request, callbackQueue: callbackQueue, multipartFormData: multipartFormData, progress: progress, redirectHandler: redirectHandler, cachedResponseHandler: cachedResponseHandler, completion: completion)
        }
        ...
        case .never:
            ...
            case .requestPlain, .requestData, .requestJSONEncodable, .requestCustomJSONEncodable, .requestParameters, .requestCompositeData, .requestCompositeParameters:
                return self.sendRequest(target, request: request, callbackQueue: callbackQueue, progress: progress, redirectHandler: redirectHandler, cachedResponseHandler: cachedResponseHandler, completion: completion)
            case .uploadFile(let file):
                return self.sendUploadFile(target, request: request, callbackQueue: callbackQueue, file: file, progress: progress, redirectHandler: redirectHandler, cachedResponseHandler: cachedResponseHandler, completion: completion)
            ...
            case .downloadDestination(let destination), .downloadParameters(_, _, let destination):
                return self.sendDownloadRequest(target, request: request, callbackQueue: callbackQueue, destination: destination, progress: progress, redirectHandler: redirectHandler, cachedResponseHandler: cachedResponseHandler, completion: completion)
            }
        default:
...
private extension MoyaProvider {
    ...
    func sendUploadMultipart(_ target: Target, request: URLRequest, callbackQueue: DispatchQueue?, multipartFormData: MultipartFormData, progress: Moya.ProgressBlock? = nil, redirectHandler: RedirectHandler? = nil, cachedResponseHandler: CachedResponseHandler? = nil, completion: @escaping Moya.Completion) -> CancellableToken {
        ...
        return sendAlamofireRequest(validatedRequest, target: target, callbackQueue: callbackQueue, progress: progress, redirectHandler: redirectHandler, cachedResponseHandler: cachedResponseHandler, completion: completion)
    }

    func sendUploadFile(_ target: Target, request: URLRequest, callbackQueue: DispatchQueue?, file: URL, progress: ProgressBlock? = nil, redirectHandler: RedirectHandler? = nil, cachedResponseHandler: CachedResponseHandler? = nil, completion: @escaping Completion) -> CancellableToken {
        let interceptor = self.interceptor(target: target)
        let uploadRequest: UploadRequest = session.requestQueue.sync {
        ...
        return sendAlamofireRequest(alamoRequest, target: target, callbackQueue: callbackQueue, progress: progress, redirectHandler: redirectHandler, cachedResponseHandler: cachedResponseHandler, completion: completion)
    }

    func sendDownloadRequest(_ target: Target, request: URLRequest, callbackQueue: DispatchQueue?, destination: @escaping DownloadDestination, progress: ProgressBlock? = nil, redirectHandler: RedirectHandler? = nil, cachedResponseHandler: CachedResponseHandler? = nil, completion: @escaping Completion) -> CancellableToken {
        let interceptor = self.interceptor(target: target)
    ...
    func sendRequest(_ target: Target, request: URLRequest, callbackQueue: DispatchQueue?, progress: Moya.ProgressBlock?, redirectHandler: RedirectHandler? = nil, cachedResponseHandler: CachedResponseHandler? = nil, completion: @escaping Moya.Completion) -> CancellableToken {
        let interceptor = self.interceptor(target: target)
    ...
    func sendAlamofireRequest<T>(_ alamoRequest: T, target: Target, callbackQueue: DispatchQueue?, progress progressCompletion: Moya.ProgressBlock?, redirectHandler: RedirectHandler? = nil, cachedResponseHandler: CachedResponseHandler? = nil, completion: @escaping Moya.Completion) -> CancellableToken where T: Requestable, T: Request {
        ...
        if let redirectHandler {
            progressAlamoRequest = progressAlamoRequest.redirect(using: redirectHandler)
        }
        if let cachedResponseHandler {
            progressAlamoRequest = progressAlamoRequest.cacheResponse(using: cachedResponseHandler)
        }

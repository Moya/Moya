...
海! 你喜欢 Moya吗? 非常棒! 我们真的可以用你的帮助!

开源不仅仅是写代码. Moya 可以在以下几个方面使用到你的帮助:
...
如果您对其中任何一个感兴趣，请发送一个请求! 经过几轮贡献, 我们会把您作为管理员添加到repo中，这样您就可以合并pull 请求并且帮助驾驶这艘船:ship: 您可以在 [in our contributor guidelines](https://github.com/Moya/contributors).阅读更多详情
...
请注意，这个项目是用Contributor Code of Conduct发布的. 为了参与到这个项目中来，您需要遵守 [its terms](https://github.com/Moya/contributors/blob/master/Code%20of%20Conduct.md)中条目.
